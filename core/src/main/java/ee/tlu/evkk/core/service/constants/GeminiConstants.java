...
public class GeminiConstants {
  ...
  public static final String EXERCISE_TYPE_ADJECTIVE_PROMPT_PART = "Harjutuse tüüp on 'omadussõnad'. Harjutuse mõte on seega harjutada sõnavara. Sisult tähendab see, et lüngas olevale omadussõnale peab järgnema nimisõna ning omadussõna roll peab olema eestäiend.";
  public static final String EXERCISE_TYPE_INFINITIVE_PROMPT_PART = "Harjutuse tüüp on 'da- ja ma-infinitiiv ehk tegevusnimi'. See tähendab, et harjutuse mõte on praktiseerida da-/ta- ja ma- lõpuliste tegusõnade käändevorme.";
  public static final String EXERCISE_TYPE_OBJECT_PROMPT_PART = "Harjutuse tüüp on 'sihitise käänded'. Sihitis on tegusõna laiend, mis näitab, kellele või millele on tegevus suunatud. Harjutuses tuleb sisestada nimisõna, mis on mitmuses ning kas nimetavas, omastavas või osastavas käändes. Harjutuse mõte on praktiseerida sihitise käänete kasutamist.";
}

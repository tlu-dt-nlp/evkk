export const TRANSLATIONS_ET = {
  ...
  corrector_complexity_infobox_word_length_outro: 'Selleks, et aidata teksti toimetada ja lihtsustada, on tekstikastis esile toodud pikad sõnad ja laused ning nimisõnad. Jaan Miku eeskujul loetakse pikaks lauseid, mis koosnevad rohkem kui 17 sõnast. Selliseid lauseid ei jõua lugeja tõenäoliselt tervikuna lühiajalisse mällu talletada (loe lähemalt <link>siit</link>).',
  ...
  corrector_vocabulary_infobox_lexical_density: '<bold>Leksikaalne tihedus</bold> väljendab sisusõnade osakaalu tekstis. Nende eristamiseks sisutühjadest funktsioonisõnadest (nt ase-, side- ja kaassõnad, abimäärsõnad ja abitegusõnad) kasutatakse <link>Kristel Uiboaia stoppsõnade loendit.</link>',

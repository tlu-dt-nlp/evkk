export const TRANSLATIONS_ET = {
  ...
  exercise_generator_exercise_format_hover: '<bold>Täida lüngad:</bold> iga lünga kõrval on sõna algvorm, mis tuleb lünka kirjutada õiges vormis.<br /><br /><bold>Vali sõna:</bold> lohista õiged vastused lünkadesse.',
  ...
  exercise_generator_exercise_sentence_count_hover: '<bold>Lausepõhise struktuuri korral –</bold> harjutuses olevate lausete maksimaalne arv (tingimusel, et lauses on vähemalt üks lünk).<br /><br /><bold>Tekstipõhise struktuuri korral –</bold> kogu teksti maksimaalne lausete arv (tingimusel, et tekstis on kokku vähemalt 5 lünka).<br /><br />Väärtus saab olla vahemikus 5–25, olenemata struktuurist.',
  exercise_generator_exercise_structure_type: 'Struktuur',
  exercise_generator_exercise_structure_type_hover: '<bold>Lausepõhine:</bold> harjutus luuakse üksikutest lausetest (samast või erinevatest terviktekstidest).<br /><br /><bold>Tekstipõhine:</bold> harjutus luuakse ühe tervikteksti põhjal.',
  ...
  exercise_generator_exercise_target_word_criteria_hover: 'Võimaldab valida harjutuse vastuste taset vastavalt Eesti Keele Instituudi (EKI) <vocabularyLink>sõnavara nimekirjadele</vocabularyLink>.',
  ...
  exercise_generator_exercise_topic_hover: 'Võimaldab määrata teemavaldkonna, millest tekst räägib. Lausepõhise struktuuri korral on see valik ebatäpsem, kuna iga lause temaatilisest terviktekstist ei pruugi teemavaldkonda edasi anda.',
  ...
  exercise_generator_exercise_type_hover: '<bold>Da- ja ma-infinitiiv ehk tegevusnimi:</bold> da- ja ma- lõpuliste tegusõnade käändevormide harjutamine.<br /><br /><bold>Sihitise käänded:</bold> sihitis on tegusõna laiend, mis näitab, kellele või millele on tegevus suunatud. Harjutuses tuleb sisestada nimisõna, mis on mitmuses ning kas nimetavas, omastavas või osastavas käändes.<br /><br /><bold>Omadussõnad:</bold> harjuta oma sõnavara, valides, milline omadussõna sobib lünka kõige paremini.',
  ...
  exercise_generator_perform_quality_check_hover: 'Kvaliteedikontroll aitab välistada ebasobivaid ja arusaamatuid lauseid, tekste ja lünkasid, kuid aeglustab genereerimist ning võib anda nii valepositiivseid kui ka -negatiivseid tulemusi.',

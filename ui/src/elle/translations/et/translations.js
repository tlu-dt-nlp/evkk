export const TRANSLATIONS_ET = {
  ...
  exercise_generator_exercise_completed_with_mistakes: 'Õigeid vastuseid: {{correctAnswers}}/{{totalAnswers}}. Valed vastused on märgitud punasega. Nendel hiirega liikudes või klikkides näed selgitusi ning kõrval näed õigeid vastuseid.',
  ...
  exercise_generator_exercise_sentence_count_max: 'Maksimaalne lausete arv',

export const TRANSLATIONS_ET = {
  ...
  exercise_generator_exercise_format: 'Formaat',
  ...
  exercise_generator_exercise_topic: 'Teema',
  ...
  exercise_generator_exercise_topic_hover: 'Võimaldab määrata teema, millest tekst räägib. Lausepõhise struktuuri korral on see valik ebatäpsem, kuna iga lause temaatilisest terviktekstist ei pruugi teemat edasi anda.',
  ...
  exercise_generator_exercise_type_hover: '<bold>Da- ja ma-infinitiiv ehk tegevusnimi:</bold> da- ja ma- lõpuliste tegusõnade käändevormide harjutamine.<br /><br /><bold>Sihitise käänded:</bold> sihitis on tegusõna laiend, mis näitab, kellele või millele on tegevus suunatud. Harjutuses tuleb sisestada nimisõna, mis on mitmuses ning kas nimetavas, omastavas või osastavas käändes.',

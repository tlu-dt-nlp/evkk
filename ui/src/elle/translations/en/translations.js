export const TRANSLATIONS_EN = {
  ...
  corrector_complexity_infobox_word_length_outro: 'To make editing and simplifying the text easier, the text box highlights long words, phrases, and nouns. Based on Jaan Mikk\'s example, sentences that go beyond 17 words are considered long. The reader\'s short-term memory is unlikely to store such sentences in their entirety (read more <link>here</link>).',
  ...
  corrector_vocabulary_infobox_lexical_density: '<bold>Lexical density</bold> is the proportion of content words in a text. To distinguish them from function words (e.g. pronouns, conjunctions, adpositions, verbal particles and auxiliary verbs), <link>Kristel Uiboaed\'s list of stop words is used.</link>',

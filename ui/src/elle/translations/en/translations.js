export const TRANSLATIONS_EN = {
  ...
  exercise_generator_exercise_format_hover: '<bold>Fill-in-the-blanks:</bold> next to each blank is the base form of the word, which must be written in the correct form in the blank.<br /><br /><bold>Select word:</bold> drag the correct answers into the blanks.',
  ...
  exercise_generator_exercise_sentence_count_hover: '<bold>For sentence-based structure –</bold> the maximum number of sentences in the exercise (provided that each sentence contains at least one blank).<br /><br /><bold>For text-based structure –</bold> the maximum number of sentences in the full text (provided that the text contains at least 5 blanks in total).<br /><br />The value can be in the range of 5–25, regardless of structure.',
  exercise_generator_exercise_structure_type: 'Structure',
  exercise_generator_exercise_structure_type_hover: '<bold>Sentence-based:</bold> the exercise is created from individual sentences (from the same or different full texts).<br /><br /><bold>Text-based:</bold> the exercise is created based on one full text.',
  ...
  exercise_generator_exercise_target_word_criteria_hover: 'Allows selecting the language level of exercise answers according to the Institute of the Estonian Language (EKI) <vocabularyLink>vocabulary lists</vocabularyLink>.',
  ...
  exercise_generator_exercise_topic_hover: 'Allows setting the topic the text is about. In sentence-based structure, this option is less precise, since each sentence may not reflect the topic of its full source text.',
  ...
  exercise_generator_exercise_type_hover: '<bold>Da- and ma-infinitive:</bold> practice the case forms of verbs ending in -da and -ma.<br /><br /><bold>Object cases:</bold> the object is a verb complement that shows who or what the action is directed at. In the exercise, you must enter a noun in the plural, in either the nominative, genitive, or partitive case.<br /><br /><bold>Adjectives:</bold> practice your vocabulary by choosing which adjective fits the blank best.',
  ...
  exercise_generator_fill_in_the_blanks_interaction_hint: 'Choose the suitable word and write it in the blank.',
  ...
  exercise_generator_perform_quality_check_hover: 'Quality check helps filter out unsuitable and unclear sentences, texts, and blanks, but it slows down generation and may produce both false positives and false negatives.',

  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <b>{t('corrector_complexity_infobox_flesch_kincaid_bold')}</b>{' '}
          {t('corrector_complexity_infobox_flesch_kincaid_value')}
          <br></br>
        ...
        <li>
          <b>{t('corrector_complexity_infobox_noun_to_verb_bold')}</b>{' '}
          {t('corrector_complexity_infobox_noun_to_verb_value')}
        </li>
      </ul>
